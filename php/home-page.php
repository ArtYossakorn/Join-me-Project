...
<body>
                    ...
                    <div class="post-container">
                        ...
                        if (!empty($row['images'])) {
                            ...
                            foreach ($images as $index => $imageUrl) {
                                ...
                                echo '<a href="post-detail.php?postID=' . $postKey . '">';
                        ...
                        ?>
                            <form action="register-action.php" method="POST">
                                ...
                                <button type="submit" class="btn-submit" name="reg-btn">ลงชื่อเข้าร่วมกิจกรรม</button>
                            </form>
                        <?php
                        }
                        ?>
    ...
    <script src="../script/script_imageSlide.js" defer></script>
